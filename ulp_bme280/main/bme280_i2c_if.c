...
{
	bme280_device.settings.osr_h = BME280_OVERSAMPLING_1X;
	bme280_device.settings.osr_p = BME280_OVERSAMPLING_1X;
	bme280_device.settings.osr_t = BME280_OVERSAMPLING_1X;
...
int8_t bme280_i2c_config() {

	get_data_bme280_i2c_task(NULL);
	return 0;
	//standard for weather-sensor
